...
RepresentedBoard::RepresentedBoard(SudokuBoard newBoard) : base(newBoard), givens(newBoard.givens)
{ 
    
}
RepresentedBoard::RepresentedBoard(){
};
...
bool RepresentedBoard::validate(SudokuBoard &newBoard){
...
RepresentedBoard RepresentedBoard::newRep(SudokuBoard board) {
