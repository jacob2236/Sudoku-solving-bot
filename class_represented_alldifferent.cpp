...
RepresentedAllDifferent::RepresentedAllDifferent(SudokuBoard newBoard) : RepresentedBoard(newBoard)
{ 
    
}
RepresentedAllDifferent::RepresentedAllDifferent(){
};
...
bool RepresentedAllDifferent::validate(SudokuBoard &newBoard){
...
RepresentedAllDifferent RepresentedAllDifferent::newRep(SudokuBoard board) {
